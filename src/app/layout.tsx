...
export const metadata: Metadata = {
  title: "TechShop Milano VC | Venture Capital Investment",
  description: "Empowering European tech founders with strategic capital, expertise, and network. Invest in AI, fintech, and healthtech innovators.",
  keywords: "venture capital, tech investment, startup funding, Milan, Europe, AI, fintech, healthtech",
  metadataBase: new URL("https://techshopmilano.vc"),
  alternates: {
    canonical: "https://techshopmilano.vc"
  },
  openGraph: {
    title: "TechShop Milano VC | Venture Capital Investment",
    description: "Empowering European tech founders with strategic capital, expertise, and network.",
    url: "https://techshopmilano.vc",
    siteName: "TechShop Milano VC",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764145514021-gkr4t773.jpg",
      alt: "TechShop Milano VC Investment"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "TechShop Milano VC | Venture Capital Investment",
    description: "Empowering European tech founders with strategic capital and expertise.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764145514021-gkr4t773.jpg"]
  },
  robots: {
    index: true,
    follow: true
